...
COPY custom_model/model.py custom_model/model.py
COPY custom_model/data/branching_nodes_candidate_splits.json /home/kserve/branching_nodes_candidate_splits.json
COPY custom_model/bdq_agent.py custom_model/bdq_agent.py
COPY custom_model/data/initial_state.npy /home/kserve/initial_state.npy
COPY candidate_splits_10_nodes.txt /home/kserve
